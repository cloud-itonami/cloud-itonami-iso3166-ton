(ns marketentry.marketentryllm
  ...
  the Kingdom of Tonga (TON) public-sector market-entry compliance
  actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "seeks-firc?=" (:seeks-firc? e)
                        " business-sector=" (:business-sector e)
                        " tongan-equity-pct=" (:tongan-equity-pct e)
                        " paid-up-capital=" (:paid-up-capital e)
