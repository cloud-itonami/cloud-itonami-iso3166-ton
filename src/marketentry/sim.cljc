...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (TON, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up foreign-investment-ineligible) ==")
    ...
    (println "== filing/submit eng-4 (foreign-investment-ineligible -> HARD hold) ==")
